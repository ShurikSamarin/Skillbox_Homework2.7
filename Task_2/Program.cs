...
Console.WriteLine("FIO: {0} | Age: {1} | Email: {2}", fullName, age.ToString(), email); 
Console.WriteLine("Programming scores: {0} | Math scores: {1} | Physics scores: {2}", progBall.ToString(), mathBall.ToString(), physBall.ToString());
Console.WriteLine("");
Console.ReadKey();
...
Console.WriteLine("Average scores: {0} ", result.ToString());
